...
//            bench = new ColumnStoreBWBenchmark(argv[1], argv[2], Constants::N_THREADS);
//            sleep(15);
//            break;
//        default:
//            exit(EXIT_FAILURE);
//    }
    ...
    cout << sizeof(Tuple) << endl;

    bench = new MergeBenchmark(argv[1], argv[2], get_file_size(argv[1]), 4, Constants::N_THREADS);
